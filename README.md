...
* Para este proyecto es opcional el uso de ES Modules `(import/export)`, en el
  caso que optes utilizarlo deberás crear un script de `build` en el `package.json`
...
quedar detallado en el `README.md` de tu repo y en trello. Además, puedes usar una serie de _issues_ y _milestones_ en github para priorizar y organizar el trabajo, y para poder hacer
...
## 7. Funcionalidad extra o "Hacker edition"

Las secciones llamadas _Hacker Edition_ son **opcionales**. Si alcanzaste los objetivos de aprendizaje y te queda tiempo, intenta realizar el hacker edition. Así podrás
