...
// module.exports.readDir = readDir();
  ...
  // .then((resultLinks, file, options) => {
            //   linksDefault(resultLinks, file, options);
            //   return;
            // })
            // .then(() => {
...
//_---------------------------------------------------------------------------------------------------
          ...
          //   return;
          // } else {
          //   linksValidate(resultLinks, file) // Llamada de la promesa del nuevo array con status y statusCode
